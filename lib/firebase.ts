...
export const fireBaseLogEvent = (
  ...
  if (!analytics) return;
    console.log("[firebase] fireBaseLogEvent", eventName, params);
  logEvent(analytics, eventName, params);
};

// --- Merge: stray `resolveAuth` fragment from conflict (was incorrectly inside `fireBaseLogEvent`; kept for reference) ---
// function resolveAuth(override?: Partial<FirebaseOptions>): Auth {
//   if (authSingleton) {
//     return authSingleton;
//   }
