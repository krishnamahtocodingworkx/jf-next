  ...
  return (
    <div className="flex min-h-screen">
      <div className="relative hidden w-1/2 overflow-hidden bg-white lg:flex">
        <svg className="h-full w-full" viewBox="0 0 615 588" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
          ...
          />
          <defs>
            <linearGradient id="paint0_linear_1267_452" x1="615" y1="583" x2="-2.46904" y2="7.64984" gradientUnits="userSpaceOnUse">
